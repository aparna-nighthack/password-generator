...
def main():
    ...
    parser.add_argument("--include-special-chars", action='store_true', help="Include special characters in the password.")
    ...
    try:
        password = generate_password(password_length, include_numbers, include_special_chars, include_uppercase)
